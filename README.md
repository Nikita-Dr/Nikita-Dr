...
В рамках обучения, реализовал программу для чтения bmp файлов, далее на его основе реализовал программу для вывода его на экран в консоли. [bmp](https://github.com/Nikita-Dr/c-bmp-displayer/blob/main/main1.cpp)
